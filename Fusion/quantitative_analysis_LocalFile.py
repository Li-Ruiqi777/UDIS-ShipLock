...
if __name__ == "__main__":
    ...
    parser.add_argument('--fusion_result_folder', type=str, default='F:/MasterGraduate/03-Code/UDIS-ShipLock/results/Fusion/UDIS2')
    parser.add_argument('--fusion_result_path', type=str, default='')
    args = parser.parse_args()
    
    if(args.fusion_result_path == ''):
        sorted_folders = natsorted(os.listdir(args.fusion_result_folder))
        # sorted_folders = sorted_folders[-5:]
        for folder in sorted_folders:
            args.fusion_result_path = os.path.join(args.fusion_result_folder, folder)

...
def get_boundary_term(inpu1_tesnor, inpu2_tesnor, mask1_tesnor, mask2_tesnor, stitched_image):
...
def get_smooth_term_stitch(stitched_image, learned_mask1):
...
def get_smooth_term_diff(img1, img2, learned_mask1, overlap):
